...
/**
 * Frozen Phase 3 cutover copy of the handwritten {@link StageFactory} switch.
 * Production does not call this class. Parity tests compare it to the generated registry.
 */
final class LegacyStageFactory {
