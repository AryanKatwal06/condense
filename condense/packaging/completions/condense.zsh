...
_condense() {
  ...
  proxy_commands=(
    ...
    'tsc:Proxy tsc'
    'ruff:Proxy ruff'
    'pip:Proxy pip install'
    'python:Proxy python -m pytest / mypy'
    'mypy:Proxy mypy'
    'dotnet:Proxy dotnet test/build/restore'
    'bundle:Proxy bundle install'
    'rspec:Proxy rspec'
    'rubocop:Proxy rubocop'
    'terraform:Proxy terraform plan/apply'
    'helm:Proxy helm install/upgrade/list'
    'gh:Proxy gh pr/issue/run list'
    'glab:Proxy glab mr/issue/ci list'
    'curl:Proxy curl'
    'wget:Proxy wget'
    'psql:Proxy psql'
    'pnpm:Proxy pnpm install'
    'next:Proxy next build'
    'prisma:Proxy prisma migrate/generate'
    'playwright:Proxy playwright test'
    'prettier:Proxy prettier'
  )
